...
%CC% -std=c++17 -pedantic-errors -O3 -DNDEBUG -pthread -DGAME_VERSION=\"%VAR%\" src\client\*.cpp src\imgui\*.cpp -o build\surv-royale-client -I win\include -L win\lib -mwindows -lsfml-graphics-2 -lsfml-window-2 -lsfml-audio-2 -lsfml-network-2 -lsfml-system-2 -lopengl32
